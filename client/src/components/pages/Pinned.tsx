...
import { Loader2, Pin, Menu } from 'lucide-react';
...
export default function Pinned() {
  ...
  const { 
    ...
    queryFn: async () => {
      ...
      console.log('Pinned API Response:', response.data);
      ...
      <div className="flex-1 overflow-auto">
        ...
        <div className="lg:hidden p-4 border-b border-orange-200 bg-white">
          <div className="flex items-center justify-between">
            ...
            <h1 className="text-xl font-bold text-gray-800">Pinned</h1>
            <Button
              onClick={() => refetch()}
              size="sm"
              variant="ghost"
        ...
        <main className="p-4 lg:p-8">
          ...
          <div className="lg:hidden mb-6">
            <div className="text-center">
              <h1 className="text-2xl font-bold text-gray-800 mb-1">Pinned Notes</h1>
              <p className="text-gray-600">
                {notes.length} {notes.length === 1 ? 'pinned note' : 'pinned notes'}
              </p>
            </div>
          ...
          {isLoading && notes.length === 0 ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 text-center">
              <div className="mb-6 flex items-center justify-center rounded-3xl bg-blue-50 p-6 border border-blue-200">
                <Pin className="h-12 w-12 text-blue-500" />
              </div>
              <h2 className="text-2xl font-bold text-gray-800 mb-2">
                No pinned notes yet
              </h2>
              <p className="text-gray-600 mb-6 max-w-sm">
                Click the pin icon on any note to add it to your pinned notes for quick access.
              </p>
          ...
          {isError && (
            <div className="text-center py-20">
              <div className="mb-6 flex items-center justify-center rounded-3xl bg-red-50 p-6 border border-red-200">
                <Pin className="h-12 w-12 text-red-500" />
              </div>
              <h2 className="text-2xl font-bold text-gray-800 mb-2">
